  ...
  if (totalClicks < 26) { //total clicks starts at one once first page is loaded, so 26-1=25
    ...
    function displayTotals(){ //turns each image object into a list item diplaying total times each one is shown and how many times it was clicked on
      ...
      var chart = new Chart(ctx, {
        ...
        data: {
          labels: [
            imgObjArr[0].name, imgObjArr[1].name, imgObjArr[2].name, imgObjArr[3].name, imgObjArr[4].name, imgObjArr[5].name, imgObjArr[6].name, imgObjArr[7].name, imgObjArr[8].name, imgObjArr[9].name, imgObjArr[10].name, imgObjArr[11].name, imgObjArr[12].name, imgObjArr[13].name, imgObjArr[14].name, imgObjArr[15].name, imgObjArr[16].name, imgObjArr[17].name, imgObjArr[18].name, imgObjArr[19].name
          ],
          datasets: [{
